...
export const AvatarChat: React.FC<AvatarChatProps> = ({ isOpen, onClose, theme, employeeName }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
      <div className={`w-full max-w-md h-[600px] flex flex-col rounded-2xl shadow-2xl overflow-hidden ${theme.colors.cardBg} ${theme.colors.text}`}>
        ...
        <div className={`p-4 flex items-center justify-between border-b ${theme.colors.border} ${theme.colors.bg}`}>
          <div className="flex items-center gap-2">
            ...
            <div>
              <h3 className="font-semibold text-sm">Ask {employeeName}</h3>
